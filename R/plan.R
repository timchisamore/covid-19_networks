plan <- drake_plan(
  ...
  filter_ccm_exposure_investigations_and_exposures_data = filtering_exposure_investigations_and_exposures_data(join_ccm_exposure_investigations_and_exposures_data, clean_ccm_exposure_investigations_acquisition_data, clean_ccm_investigations_data),
  create_covid_19_network_data = creating_covid_19_network_data(filter_ccm_exposure_investigations_and_exposures_data, clean_ccm_investigations_data),
