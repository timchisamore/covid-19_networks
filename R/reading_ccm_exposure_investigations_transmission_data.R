...
#'
#' @param ccm_exposure_investigations_transmission_path A pathway to the CCM
#' Exposure Investigations - Transmission data file.
#'
#' @return A `tbl_df` of our CCM Exposure Investigations - Transmission data.
#' @export
#'
#' @examples
...
reading_ccm_exposure_investigations_transmission_data <- function(ccm_exposure_investigations_transmission_path) {
  ...
  return(raw_ccm_exposure_investigations_transmission_data)
}
