...
#' objects.
#'
#' @param raw_ccm_exposure_investigations_acquisition_data A tbl_df of raw CCM
#' exposure investigations - acquisition data.
#'
#' @return A tbl_df of clean CCM exposure invesetigations - acquisition data.
#' @export
#'
#' @examples
