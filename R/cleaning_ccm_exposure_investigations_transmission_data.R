...
#' objects.
#'
#' @param raw_ccm_exposure_investigations_transmission_data A `tbl_df` of our
#' raw CCM exposure investigations - transmission data.
#'
#' @return A `tbl_df` of our cleaned CCM exposure investigations - transmission
#' data.
#' @export
#'
#' @examples
...
cleaning_ccm_exposure_investigations_transmission_data <- function(raw_ccm_exposure_investigations_transmission_data) {
  clean_ccm_exposure_investigations_transmission_data <- raw_ccm_exposure_investigations_transmission_data %>%
    janitor::clean_names() %>%
    mutate(
  ...
  return(clean_ccm_exposure_investigations_transmission_data)
}
